...
逐段扫描画面和文字稿，不能只搜索预先知道的核心股。所有明确提到的股票都进入清单，包括一带而过、负面评价、对比对象、跟风股和作者不看好的股票。
...
完成股票名核实后，检查整理文字稿是否覆盖全片议题、全部股票、新手教学、长篇观点和次日计划，并确认“本期全部股票提及表”完整。将文字稿写入正式路径后冻结；冻结前禁止创建或预写总结。
