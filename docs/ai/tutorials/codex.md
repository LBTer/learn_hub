...
![Codex CLI 安装命令示意图](https://learn.luovista.com/codex/install-cli.svg)
...
![Codex 登录方式示意图](https://learn.luovista.com/codex/login.svg)
...
![美区 Apple 礼品卡订阅流程示意图](https://learn.luovista.com/codex/apple-gift-card-flow.svg)
